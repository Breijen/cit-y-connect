...
@export var sunLightIntensity : Curve = preload("res://Sky/Presets/default/sunLightIntensity.tres")
...
@export var moonLightIntensity : Curve = preload("res://Sky/Presets/default/moonLightIntensity.tres")
...
@export var baseSkyColor : GradientTexture1D = preload("res://Sky/Presets/default/baseSkyColor.tres")
@export var baseCloudColor : GradientTexture1D = preload("res://Sky/Presets/default/baseCloudColor.tres")
@export var overcastCloudColor : GradientTexture1D = preload("res://Sky/Presets/default/overcastCloudColor.tres")
@export var horizonFogColor : GradientTexture1D = preload("res://Sky/Presets/default/horizonFogColor.tres")
@export var sunLightColor : GradientTexture1D = preload("res://Sky/Presets/default/sunLight.tres")
@export var sunDiscColor : GradientTexture1D = preload("res://Sky/Presets/default/sunDiscColor.tres")
@export var sunGlow : GradientTexture1D = preload("res://Sky/Presets/default/sunGlowColor.tres")
@export var moonLightColor : GradientTexture1D = preload("res://Sky/Presets/default/moonLight.tres")
@export var moonGlowColor : GradientTexture1D = preload("res://Sky/Presets/default/moonGlowColor.tres")
